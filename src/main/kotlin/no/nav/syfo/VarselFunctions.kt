...
fun NarmesteLederHendelse.dialogmoteNarmesteLederTexts(): DialogmoteNarmesteLederTexts {
    val greeting = this.data?.toVarselData()?.narmesteLeder?.navn?.let { navn -> "Til <body>$navn,<br><br>" }
        ?: "<body>Hei.<br><br>"
    return when (this.type) {
        NL_DIALOGMOTE_INNKALT -> DialogmoteNarmesteLederTexts(
        ...
        NL_DIALOGMOTE_AVLYST -> DialogmoteNarmesteLederTexts(
        ...
        NL_DIALOGMOTE_NYTT_TID_STED -> DialogmoteNarmesteLederTexts(
        ...
        NL_DIALOGMOTE_REFERAT -> DialogmoteNarmesteLederTexts(
