...
import no.nav.syfo.kafka.common.TOPIC_ARBEIDSTAKER_VARSEL
...
class ArbeidstakervarselKafkaConsumer(
    ...
    init {
        ...
        kafkaListener.subscribe(listOf(TOPIC_ARBEIDSTAKER_VARSEL))
    }

    override suspend fun listen(applicationState: ApplicationState) {
        log.info("Started listening to topic $TOPIC_ARBEIDSTAKER_VARSEL")
