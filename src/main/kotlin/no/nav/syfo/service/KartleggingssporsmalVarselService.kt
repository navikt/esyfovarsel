...
import no.nav.syfo.DITT_SYKEFRAVAER_KARTLEGGINGSSPORSMAL_MESSAGE_TEXT
...
// TODO
// Lag tekst for `DITT_SYKEFRAVAER_KARTLEGGINGSSPORSMAL_MESSAGE_TEXT`
// Lag tekst for `BRUKERNOTIFIKASJONER_SYKEFRAVAER_KARTLEGGINGSSPORSMAL_MESSAGE_TEXT`
class KartleggingssporsmalVarselService(
    ...
    private fun sendOppgaveTilDittSykefravaer(
        ...
        val melding = DittSykefravaerMelding(
            OpprettMelding(
                ...
                LocalDateTime.now().plusWeeks(OPPGAVE_UKER_SYNLIG).toInstant(ZoneOffset.UTC),
            ),
            null,
            fnr,
        )
    ...
    companion object {
        ...
        private const val OPPGAVE_UKER_SYNLIG: Long = 13
